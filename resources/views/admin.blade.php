...
<head>
    ...
    <!-- FontAwesome 4.3.0-->
    <link href="{{ asset('/static/admin/font-awesome-4.3.0/css/font-awesome.min.css')}}" rel="stylesheet"
          type="text/css"/>
    ...
    <!-- jvectormap -->
    <link href="{{ asset('/static/admin/plugins/jvectormap/jquery-jvectormap-1.2.2.css')}}" rel="stylesheet"
          type="text/css"/>
    <!-- Date Picker -->
    <link href="{{ asset('/static/admin/plugins/datepicker/datepicker3.css')}}" rel="stylesheet" type="text/css"/>
    <!-- Daterange picker -->
    <link href="{{ asset('/static/admin/plugins/daterangepicker/daterangepicker-bs3.css')}}" rel="stylesheet"
          type="text/css"/>
    <!-- bootstrap wysihtml5 - text editor -->
    <link href="{{ asset('/static/admin/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css')}}" rel="stylesheet"
          type="text/css"/>
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="{{ url('/admin/dashboard') }}" class="logo">
            ...
            <span class="logo-mini"><b>YB</b>CT</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>推图家后台</b></span>
        </a>
        ...
        <span class="hidden-xs">
            <?php
            $user = Auth::user();
            echo $user->nick ? $user->nick : $user->name
            ?>
        </span>
                        </a>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <iframe src="{{asset('/admin/profile')}}" style="width:100%;min-height:600px;" framespacing="0"
                    frameborder="no" border="0" id="contentIframe" name="contentIframe"></iframe>
        </section>
        <!-- /.content -->
    </div>
...
<!-- jvectormap -->
<script src="{{ asset('/static/admin/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js')}}"
        type="text/javascript"></script>
<script src="{{ asset('/static/admin/plugins/jvectormap/jquery-jvectormap-world-mill-en.js')}}"
        type="text/javascript"></script>
<!-- jQuery Knob Chart -->
...
<!-- Bootstrap WYSIHTML5 -->
<script src="{{ asset('/static/admin/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js')}}"
        type="text/javascript"></script>
<!-- Slimscroll -->
