...
<head>
    ...
    <link rel="stylesheet" href="{{asset('static/webadmin/')}}/css/bootstrap.min.css" />
    <link rel="stylesheet" href="{{asset('static/webadmin/')}}/css/bootstrap-responsive.min.css" />
    <link rel="stylesheet" href="{{asset('static/webadmin/')}}/css/matrix-style.css" />
    <link rel="stylesheet" href="{{asset('static/webadmin/')}}/css/matrix-media.css" />
    <link href="{{asset('static/webadmin/')}}/font-awesome/css/font-awesome.css" rel="stylesheet" />
</head>
<body>
    <!--Header-part-->
    <div id="header">
    ...
    <div id="user-nav" class="navbar navbar-inverse">
        <ul class="nav">
            ...
            <li class=""><a title="" href="{{url('webadmin/home/destorysession')}}"><i class="icon icon-share-alt"></i> <span class="text">&nbsp;退出系统</span></a></li>
        </ul>
    </div>
    ...
    <script src="{{asset('static/webadmin/')}}/js/excanvas.min.js"></script> 
    <script src="{{asset('static/webadmin/')}}/js/jquery.min.js"></script> 
    <script src="{{asset('static/webadmin/')}}/js/jquery.ui.custom.js"></script> 
    <script src="{{asset('static/webadmin/')}}/js/bootstrap.min.js"></script> 
    <script src="{{asset('static/webadmin/')}}/js/nicescroll/jquery.nicescroll.min.js"></script> 
    <script src="{{asset('static/webadmin/')}}/js/matrix.js"></script> 
