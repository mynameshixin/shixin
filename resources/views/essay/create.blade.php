    ...
    <div><h1>自适应边框</h1>
     ...
     <script id="editor" type="text/plain" name="cont" style="width:944px;height:500px;">
			...
			<div class="edit-con ec-info">
				<div class="vr_line">
					...
					<div class="vr-right">
						...
						<label data-val="1"><i></i>样板房</label>
						
						<label data-val="2"><i></i>新房</label>
						
						<label data-val="3"><i></i>二手房改造</label>
						
						<label data-val="4"><i></i>实体店</label>
		...
		<div class="edit-tiem">
			...
			<div class="edit-con ec-info">
				<textarea name="eassat_describe" id="describe" rows="" cols=""></textarea>
			</div>
		</div>
		<div class="edit-tiem">
			<div class="edit-tit">文章标题</div>
			<div class="edit-con ec-info">
				<input type="text"  class="artcle-title" id="title" name="eassat_title" placeholder="大标签(文章名)"/>
			</div>
		</div>
		<div class="edit-tiem">
