<form action="/api/cq/pub" method="post" enctype="multipart/form-data">
	...
	<input type="text" name="price" value="300"></input><br>
	<input type="text" name="reserve_price" value="100"></input><br>
	<input type="text" name="source" value="1"></input><br>
	<input type="text" name="contact" value="1355698895"></input><br>
	<input type="text" name="tags" value="分类1；分类2"></input><br>
