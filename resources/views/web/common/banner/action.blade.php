<div class="header_add_iwrap">
            ...
            <div class="header_add_item_awrap">
              <a href="javascript:;" target="_blank" class="header_add_item_a header_more_a1 ua">上传图片</a>
              <a href="javascript:;" target="_blank" class="header_add_item_a header_more_a2 ub">上传商品</a>
