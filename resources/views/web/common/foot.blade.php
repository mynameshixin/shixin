  ...
  <div class="pop_vr_apply" style="display: none;">
    ...
    <div class="pop_con pop_con_info" style="display: none;">
      <p class="pop_tit">
        <a href="##" class="arrow_left">返回</a>
        <span class="pop_close"></span>
      </p>
      <div class="pop_namewrap clearfix">
        <div class="pop_con_logo">
          <img src="public/images/app_logo.png"/>
        </div>
        <ul class="pay_rules">
...
<script type="text/javascript">
  //vr制作申请JS代码
      $('.arrow').click(function(){
        $(".pop_con_info").fadeIn("slow");
      })
      $('.arrow_left,.pop_con_info .pop_close').click(function(){
        $(".pop_con_info").fadeOut("slow");
      });
       $('.vr_apply').click(function(){
        ...
        $('.pop_vr_apply,.pop_vr_apply .detail_pop_cancel,.pop_vr_apply .pop_close').click(function(){
          $('.pop_vr_apply').hide();
        });
