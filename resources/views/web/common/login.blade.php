    ...
    <div class="pop_con" style="margin-left: -250px">
      ...
      <div class="pop_login_wrap clearfix">
        ...
        <div class="pop_login_conother">
          <a href="/webd/tlogin/weibo?rurl=<?php echo urlencode($_SERVER['REQUEST_URI']);?>" target="_blank" title="微博"></a>
          <a href="/webd/tlogin/wechat?rurl=<?php echo urlencode($_SERVER['REQUEST_URI']);?>" target="_blank" title="微信"></a>
          <a href="/webd/tlogin/qq?rurl=<?php echo urlencode($_SERVER['REQUEST_URI']);?>" target="_blank" title="qq"></a>
