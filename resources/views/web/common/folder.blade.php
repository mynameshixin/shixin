		...
		<div class="detail_select_wrap haha">
			...
			<div class="w1248 w1240 clearfix">
				<div class="detail_select_con">
					...
					<a href="javascript:;" class="detail_select_cbtn detail_select_btncopys" title="复制至">复制至...</a>
					<a href="javascript:;" class="detail_select_cbtn detail_select_btnmove" title="移动至">移动至...</a>
				</div>
			</div>
		</div>
