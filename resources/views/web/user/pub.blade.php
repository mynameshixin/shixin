					...
					<div class="index_item_wrap">
						...
						<div class="index_item_info">
							...
							<div class="index_item_bottom clearfix comment">
								<a href="{{url('webd/user')}}/{{$value['user']['id']}}" class="index_item_authava" target="_blank" title="{{$value['user']['nick'] or $value['user']['username']}}">
								...
								<div class="index_item_authinfo index_item_authtalk">
									<a href="{{url('webd/user')}}/{{$value['user']['id']}}" class="index_item_authname" title="{{$value['user']['nick'] or $value['user']['username']}}">{{$value['user']['nick']}}：</a>
