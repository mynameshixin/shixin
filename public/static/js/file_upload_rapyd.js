...
var Img_upload = function () {
        ...
        $('#'+dom_id+'_upload').uploadify({
            ...
            onComplete:function(a, b ,c, d, e){
                ...
                if (d.code == 200) {
                    ...
                    images.push(data.image_id);
                    nowImages.push(data);

                    var pics = $('#'+dom_id).val();

                    if (pics.length > 0) pics += ',';
                    $('#'+dom_id).val(pics + image_ids);
                    load_image(dom_id, nowImages, 'picUrl');
                }
                return true;
    ...
    var load_image = function(dom_id,imgs,key){
        ...
        for(var i=0;i<imgs.length;i++){
            ...
            if(url_show){
                $('#edit_'+dom_id).append('<li style="float:left;margin-left:10px;"><a href="'+imgs[i][key]+'" target="_blank" style="cursor:pointer;"><img src="'+imgs[i][key]+'" width=210 ></a><br/>'+imgs[i]['name']);
            }else{
