						...
						str += '<li class="find_fold_li '+mrightzero+'" folder_id='+v.id+'>'
							+'<div class="find_fold_info clearfix">'
								...
								+'<div class="find_fold_tname">'
									+'<a href="#" target="_blank" class="find_fold_name" title="'+v.name+'">'+v.name+'</a>'
							...
							+'<div class="find_fold_limg clearfix">'
								+'<div class="find_fold_liwrap">'
									...
									+'<a href="'+glink_1+'" target="_blank" class="position" title="'+gtitle_1+'"><img src="'+gpic_1+'" alt="'+gtitle_1+'"></a>'
								+'</div>'
								+'<div class="find_fold_liwrap">'
									+'<div class="find_fold_liblur"></div>'
									+'<a href="'+glink_2+'" target="_blank" class="position" title="'+gtitle_2+'"><img src="'+gpic_2+'" alt="'+gtitle_2+'"></a>'
								+'</div>'
								+'<div class="find_fold_liwrap">'
									+'<div class="find_fold_liblur"></div>'
									+'<a href="'+glink_3+'" target="_blank" class="position" title="'+gtitle_3+'"><img src="'+gpic_3+'" alt="'+gtitle_3+'"></a>'
								+'</div>'
							+'</div>'
